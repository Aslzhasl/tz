...
var file_api_task_proto_depIdxs = []int32{
	...
	2, // 3: task.TaskService.GetTask:input_type -> task.GetTaskRequest
	8, // 4: task.TaskService.ListTasks:input_type -> task.Empty
	3, // 5: task.TaskService.UpdateTask:input_type -> task.UpdateTaskRequest
	4, // 6: task.TaskService.DeleteTask:input_type -> task.DeleteTaskRequest
	5, // 7: task.TaskService.CreateTask:output_type -> task.TaskResponse
	5, // 8: task.TaskService.GetTask:output_type -> task.TaskResponse
	6, // 9: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
	5, // 10: task.TaskService.UpdateTask:output_type -> task.TaskResponse
